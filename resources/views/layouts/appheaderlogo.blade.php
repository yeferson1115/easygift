...
<body class="check-out">
    ...
    <!-- ======= Header/Navbar ======= -->
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top header-dark header-register" style="background: #231B71 !important;padding: 0px !important;">
        @include('layouts.partials.headeronlylogo')
