                                            ...
                                            <tr>
                                                <td align="center" style="padding-bottom: 35px;">
                                                    <p style="margin: 0; color: #64748B; font-size: 15px; line-height: 1.6;">
                                                        Hemos procesado tu pedido con éxito y nos encontramos procesándolo en este momento. A continuación podrás rastrear tu pedido.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom: 1px solid #F1F5F9; margin-bottom: 30px;">
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    <span style="color: #94A3B8; font-size: 13px;">Número del pedido:</span>
