					...
					<table width="90%" class="tablealma">
									...
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#ffffff; font-family: 'Raleway', sans-serif;">
												<p style="color: #707070;font-size: 16px; margin-bottom: 0px;">Te enviamos este correo como actualización de tu pedido #{{ $order->id }} </p>
												<br>
												<p style="color: #707070;font-size: 16px; margin-bottom: 0px;font-weight: bold;">Etapa - {{$data['description']}}</p>
												<br>
												<p style="color: #707070;font-size: 16px;">Continuamos trabajando en su proyecto puedes consultar el estado en tiempo real dando clic al siguiente botón:</p>
												<br>
											</td>
										</tr>
									</table>
						...
						<tr>
							<td style="text-align: center; vertical-align: middle; background-color:#ffffff;">
								...
								<a class="btn-4" style="color:#fff;" href="https://wa.me/573502045177">Contactar asesor</a>
