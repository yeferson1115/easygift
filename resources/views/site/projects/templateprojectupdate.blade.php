					...
					<table width="90%" class="tablealma">
									...
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#ffffff; font-family: 'Raleway', sans-serif;">
												<p style="color: #707070;font-size: 16px; margin-bottom: 0px;">Te enviamos este correo como actualización de tu pedido {{ $project['id'] }} </p>
												<br>
												<p style="color: #707070;font-size: 16px;">{{ $data['description'] }}</p>
												<br>
											</td>
										</tr>
									</table>
						...
						<tr>
							<td style="text-align: center; vertical-align: middle; background-color:#ffffff;">
								<a class="button-3" href="{{ url('mis-proyectos/'.$project['id']) }}">Consultar estado</a>
							</td>
						</tr>
						<tr><td colspan="2" style="height:30px;">&nbsp;</td></tr>
						<tr><td colspan="2" style="height:30px;">&nbsp;</td></tr>
						...
						<tr>
							<td style="text-align: center; vertical-align: middle; background-color:#ffffff;">							
								<a class="btn-4" href="https://api.whatsapp.com/send?phone={{ $project['phone_asesor'] }}&text=Hola, ...">Contactar asesor</a>							
							</td>
						</tr>
						<tr><td colspan="2" style="height:30px;">&nbsp;</td></tr>
						<tr><td colspan="2" style="height:30px;">&nbsp;</td></tr>
