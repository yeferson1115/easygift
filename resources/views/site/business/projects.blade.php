                    ...
                    <div class="col-md-12">
                        ...
                        @foreach($item->productos as $key=>$product)                                                
                            <tr>
                                <td >
                                    @if($item->easybuy==1)
                                    <img style="max-width: 150px;; border-radius: 7px;" class="mb-1" src="https://kanbai.co/images/images/products/{{$product->imagen }}"> 
                                    @else
                                    <img style="max-width: 150px;; border-radius: 7px;" class="mb-1" src="https://kanbai.co/images/images/custom_request/{{$product->imagen }}"> 
                                    @endif
                                </td>
