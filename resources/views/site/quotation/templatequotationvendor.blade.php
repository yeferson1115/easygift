					...
					<table width="90%" class="tablealma">
									...
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#ffffff; font-family: 'Raleway', sans-serif;">
												...
												<br>
												<br>
												Encontraras todos los detalles de esta solicitud en tu panel administrativo.
												<br>
												<br>
												Contestala en el menor tiempo posible para no perderla y no dudes en contactar a nuestro equipo si tienes alguna duda.
											</td>
										</tr>
									</table>
								</center>
						...
						<tr>
							<td style="text-align: center; vertical-align: middle; background-color:#ffffff;">
								<a class="button-3" href="{{ url('home') }}">Ver Solicitud</a>
							</td>
						</tr>
						<tr><td colspan="2" style="height:30px;">&nbsp;</td></tr>
						<tr>
