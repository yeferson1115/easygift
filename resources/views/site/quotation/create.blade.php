        ...
        <div class="row no-gutters justify-content-center">
            <form class="form" role="form" action="javascript:void(0)" enctype="multipart/form-data" id="main-form" autocomplete="off">
                ...
                @if (count(Cart::getContent()))
                    <div class="resume-mobile mb-3 mt-2" >
                    @include('site.quotation.partials.resumemobile')
                    </div>
                            ...
                            <div class="col-md-5 info-desk" style="padding-left: 45px;">
                                @if (count(Cart::getContent()))
                                    ...
                                    @if(!is_null($product->delivery_time))
                                        <p class="quantity-quotation" >
                                            <i class="fa fa-truck" style="color: #1ED161;font-size: 25px;margin-right: 15px;" aria-hidden="true"></i> Tiempo de Entrega: 
                                    ...
                                    @endif
                                            ...
                                            @if(count($item->attributes->extra)>0)
                                                ...
                                                <p class="quantity-quotation">{{$extra['name']}} <span style="color: #1FD161;">x{{$item->quantity}}</span>: <span>${{number_format($extra['price']*$item->quantity, 0, 0, '.')}}</span></p>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-7">
                                <div class="row conten-form">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="mb-3 mb-3 mt-1rem">
                                            <label class="form-label" for="address">Ciudad y Dirección de entrega</label>
